...
const blogPostsData: BlogPost[] = [
  {
    ...
    authorBio: "Sarah is a senior full-stack developer with over 8 years of experience in web development. She specializes in React, Node.js, and cloud architecture.",
    date: "2024-01-15",
    readTime: "8 min read",
    category: "Technology",
    image: "/placeholder.svg?height=400&width=800",
    tags: ["Web Development", "AI", "SSR", "Edge Computing"],
    likes: 42,
    comments: 12,
  },
  {
